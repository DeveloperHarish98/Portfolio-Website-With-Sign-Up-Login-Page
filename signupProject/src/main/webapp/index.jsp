	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome Java Developers</h1>
			<!-- Icon Divider-->
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">Java Development - Web Development</p>
		</div>
	</header>
	<!-- Portfolio Section-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Software Developer with a passion for developing scalable web applications 
					and working across the full stack. I am looking for an opportunity to work for an organization 
					and utilize my skills acquired for self-development and the growth of the organization.</p>
				</div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <a href="https://mail.google.com/mail/?view=cm&fs=1&to=harishdubey98r@gmail.com" target="_blank">Harish Dubey</a>.
                </p>
            </div>
        </div>
    </div>
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								...
								<p class="mb-4">Log Cabin - A log cabin is a small, rustic house made from logs, 
								often associated with early American frontier life. It typically features a simple, 
								sturdy design and evokes a sense of nostalgia and connection to nature.</p>
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								<!-- Portfolio Modal - Title-->
								<h2
									class="portfolio-modal-title text-secondary text-uppercase mb-0">Tasty Cake</h2>
								<!-- Icon Divider-->
								<div class="divider-custom">
									<div class="divider-custom-line"></div>
									<div class="divider-custom-icon">
								...
								<!-- Portfolio Modal - Text-->
								<p class="mb-4">Tasty Cake - Tasty Cake is a brand known for its baked goods, 
								especially snack cakes, pies, and cupcakes. Originating in the early 20th century, 
								it’s famous for its sweet, indulgent treats enjoyed by many.</p>
								<button class="btn btn-primary" href="#!"
									data-bs-dismiss="modal">
									<i class="fas fa-times fa-fw"></i> Close Window
								</button>
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								...
								<!-- Portfolio Modal - Text-->
								<p class="mb-4">Circus Tent - A circus tent is a large, colorful fabric structure that serves as the venue for 
								circus performances. Typically featuring a peaked roof and vibrant patterns, it creates a festive atmosphere for 
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								<!-- Portfolio Modal - Title-->
								<h2
									class="portfolio-modal-title text-secondary text-uppercase mb-0">Game Controller</h2>
								<!-- Icon Divider-->
								<div class="divider-custom">
									<div class="divider-custom-line"></div>
									<div class="divider-custom-icon">
								...
								<!-- Portfolio Modal - Text-->
								<p class="mb-4">Game Controller - A game controller is a handheld device used to interact with video games. 
								It typically features buttons, joysticks, and triggers, allowing players to control characters and navigate 
								game environments. Controllers come in various designs for consoles, PCs, and mobile devices..</p>
								<button class="btn btn-primary" href="#!"
									data-bs-dismiss="modal">
									<i class="fas fa-times fa-fw"></i> Close Window
								</button>
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								...
								<!-- Portfolio Modal - Text-->
								<p class="mb-4">Locked Safe - A locked safe is a secure storage container designed to protect valuable items, 
								documents, or money. It features a locking mechanism, often with a combination or key, ensuring that only 
								authorized users can access its contents. Safes are commonly used for home security and in businesses.</p>
								<button class="btn btn-primary" href="#!"
									data-bs-dismiss="modal">
									<i class="fas fa-times fa-fw"></i> Close Window
								</button>
